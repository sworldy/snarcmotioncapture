...
// EulerView.cpp : implementation file
//
...
#endif
	m_strTitle = _T("Euler Orientation");
	m_strValueName = _T("Roll");
	m_strValueName1 = _T("Pitch");
	m_strValueName2 = _T("Yaw");
	m_strUnitName = _T("degrees");
...
BOOL CEulerView::OnEraseBkgnd(CDC* pDC) 
{
	...
	m_rectValue.right = m_rectValuePanel.right/3 - size.cx;

	m_rectValue1.left = m_rectValue.right + size.cx +45;
	...
	m_rectValue2.left = m_rectValue1.right + size.cx+45;
...
void CEulerView::OnTimer(UINT_PTR nIDEvent)
{
	// TODO: Add your message handler code here and/or call default

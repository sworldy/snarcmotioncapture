...
//	float	elast;						// ELASTICITY
	...
	AxisAngle axisangle;
	AxisAngle b_axisangle;
	tMatrix *anim_matrix;
	tVector *localposi, *globalposi;
...
void BoneSetFrameTest(t_Bone *bone,int frame);
void BoneAdvanceFrame(t_Bone *bone,int direction,BOOL doChildren);
void BoneAdvanceFrameTest0(t_Bone *bone,int direction,BOOL doChildren);
void BoneAdvanceFrameTest1(t_Bone *bone,int direction,BOOL doChildren);
void BoneAdvanceFrameTest2(t_Bone *bone,int direction,BOOL doChildren);
void BoneAdvanceFrameTest3(t_Bone *bone,int direction,BOOL doChildren);
void BoneAdvanceFrameTest4(t_Bone *bone,int direction,BOOL doChildren);
void BoneAdvanceFrameTest5(t_Bone *bone,int direction,BOOL doChildren);
void BoneAdvanceFrameTest6(t_Bone *bone,int direction,BOOL doChildren);
void BoneAdvanceFrameTest7(t_Bone *bone,int direction,BOOL doChildren);
void BoneAdvanceFrameTest8(t_Bone *bone,int direction,BOOL doChildren);
void BoneAdvanceFrameTest9(t_Bone *bone,int direction,BOOL doChildren);
void BoneAdvanceFrameTest10(t_Bone *bone,int direction,BOOL doChildren);
void BoneAdvanceFrameTest11(t_Bone *bone,int direction,BOOL doChildren);
void BoneAdvanceFrameTest12(t_Bone *bone,int direction,BOOL doChildren);
void BoneAdvanceFrameTest13(t_Bone *bone,int direction,BOOL doChildren);
void BoneAdvanceFrameTest14(t_Bone *bone,int direction,BOOL doChildren);
void BoneAdvanceFrameTest15(t_Bone *bone,int direction,BOOL doChildren);
void BoneAdvanceFrameTest16(t_Bone *bone,int direction,BOOL doChildren);

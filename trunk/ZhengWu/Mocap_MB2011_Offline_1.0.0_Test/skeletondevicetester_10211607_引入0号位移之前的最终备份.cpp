...
{
	double lcl[3],lcl1[3],lcl2[3],lcl3[3],lcl4[3],lcl5[3];
	switch (ID)
	{
	case 0:
	...
	case 13:
		...
		GetlclTrans(&lcl2[0],mDataBuffer,24,25);
		GetlclTrans(&lcl3[0],mDataBuffer,24,26);
		LocalRotation(mDataBuffer,13,17,TransMat);
		LocalRotation(mDataBuffer,13,24,TransMat);
		ForceRotation(mDataBuffer,&lcl[0],17,18);
		ForceRotation(mDataBuffer,&lcl1[0],17,19);
		ForceRotation(mDataBuffer,&lcl2[0],24,25);
		ForceRotation(mDataBuffer,&lcl3[0],24,26);
